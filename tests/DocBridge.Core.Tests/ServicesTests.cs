...
public class PolicyEngineTests : IClassFixture<TestHome>
{
    ...
    [InlineData("hwp", "table_set_repeat_header", OpClass.Allowed)]
    [InlineData("hwp", "table_set_borders", OpClass.Allowed)]
    [InlineData("hwp", "insert_footnote", OpClass.Allowed)]
    [InlineData("hwp", "insert_endnote", OpClass.Allowed)]
    ...
    [InlineData("hwp", "insert_footnote", false)]
    [InlineData("hwp", "insert_endnote", false)]
    [InlineData("hwp", "table_set_repeat_header", false)]
    [InlineData("hwp", "table_set_borders", false)]
